...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 El Balanced Scorecard ayuda a generar resultados en beneficio de la administración de la compañía, siempre y cuando se use la metodología y la aplicación para monitorear y estudiar los indicadores obtenidos del análisis.
    .row.mb-4
